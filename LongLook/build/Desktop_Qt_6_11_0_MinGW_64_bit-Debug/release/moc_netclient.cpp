...
template <> constexpr inline auto NetClient::qt_create_metaobjectdata<qt_meta_tag_ZN9NetClientE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(const LL::SensorData &)>(6, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 7, 8 },
        }}),
        // Signal 'pidTeleUpdated'
        QtMocHelpers::SignalData<void(const LL::PidSample &)>(9, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 10, 11 },
        }}),
        // Signal 'videoFrame'
        ...
        // Signal 'thermalFrame'
        QtMocHelpers::SignalData<void(const QImage &, double, double)>(15, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 13, 14 }, { QMetaType::Double, 16 }, { QMetaType::Double, 17 },
        }}),
        // Signal 'textFrame'
        ...
        // Signal 'discovered'
        QtMocHelpers::SignalData<void(const QString &, quint16, const QString &)>(20, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void NetClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->sensorUpdated((*reinterpret_cast<std::add_pointer_t<LL::SensorData>>(_a[1]))); break;
        case 4: _t->pidTeleUpdated((*reinterpret_cast<std::add_pointer_t<LL::PidSample>>(_a[1]))); break;
        case 5: _t->videoFrame((*reinterpret_cast<std::add_pointer_t<QImage>>(_a[1]))); break;
        case 6: _t->thermalFrame((*reinterpret_cast<std::add_pointer_t<QImage>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<double>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<double>>(_a[3]))); break;
        case 7: _t->textFrame((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 8: _t->discovered((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<quint16>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[3]))); break;
        ...
        case 13: _t->onConnectTimeout(); break;
        case 14: _t->onDiscoveryDatagram(); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (NetClient::*)()>(_a, &NetClient::disconnected, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (NetClient::*)(const QString & )>(_a, &NetClient::logMessage, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (NetClient::*)(const LL::SensorData & )>(_a, &NetClient::sensorUpdated, 3))
            return;
        if (QtMocHelpers::indexOfMethod<void (NetClient::*)(const LL::PidSample & )>(_a, &NetClient::pidTeleUpdated, 4))
            return;
        if (QtMocHelpers::indexOfMethod<void (NetClient::*)(const QImage & )>(_a, &NetClient::videoFrame, 5))
            return;
        if (QtMocHelpers::indexOfMethod<void (NetClient::*)(const QImage & , double , double )>(_a, &NetClient::thermalFrame, 6))
            return;
        if (QtMocHelpers::indexOfMethod<void (NetClient::*)(const QString & )>(_a, &NetClient::textFrame, 7))
            return;
        if (QtMocHelpers::indexOfMethod<void (NetClient::*)(const QString & , quint16 , const QString & )>(_a, &NetClient::discovered, 8))
            return;
    }
}
